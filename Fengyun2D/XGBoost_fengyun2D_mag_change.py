...
CSV_PATH = Path("../satellite_data/orbital_elements/Fengyun-2D.csv")
...
def main():
    ...
    # Shuffle dataset before splitting to avoid temporal ordering bias
    ...
    dump(x_scaler, "x_scaler_mag_change.joblib")
    dump(y_scaler, "y_scaler_mag_change.joblib")
 ...
 # model training
    ...
    model.save_model("test_regr_fengyun2D_mag_change.json")
