...
TARGET_COL = "Brouwer mean motion"
...
def main():
    ...
    dump(x_scaler, "x_scaler_brouwermeanmotion.joblib")
    dump(y_scaler, "y_scaler_brouwermeanmotion.joblib")
    ...
    model.save_model("test_regr_fengyun2D_brouwermeanmotion.json")
