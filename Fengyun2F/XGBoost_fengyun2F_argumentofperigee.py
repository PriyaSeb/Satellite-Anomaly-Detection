...
TARGET_COL = "argument of perigee"
...
def sliding_window_forecast(model, history, steps, x_scaler, y_scaler):
    #Iterative forecast using last WINDOW_SIZE original-scale values.
...
def main():
    ...
    dump(x_scaler, "x_scaler_argumentofperigee.joblib")
    dump(y_scaler, "y_scaler_argumentofperigee.joblib")
    ...
    model.save_model("test_regr_fengyun2F_argumentofperigee.json")
